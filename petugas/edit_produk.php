<?php
   ...
   $data=mysqli_fetch_array($qry_get_produk);
...
<html>
  ...
  <body>
      <center>
        <h1><br>Edit Produk <?php echo $data['nama_produk']; ?></br></h1>
      <center>
      ...
      <section class="base">
        ...
        <div>
          ...
          <img src="../aset/<?php echo $data['foto_produk']; ?>" style="width: 120px;float: left;margin-bottom:5px; border-radius: 15px;">
