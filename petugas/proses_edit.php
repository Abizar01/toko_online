...
if ($foto_produk != "") {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        ...
        $query  = "UPDATE produk SET nama_produk = '$nama_produk', deskripsi = '$deskripsi', harga = '$harga', foto_produk = '$nama_gambar_baru'";
        ...
        if (!$result) {
            ...
            echo "<script>alert('Data berhasil diubah.');window.location='tampil_produk.php';</script>";
        }
    } else {
