            ...
            <table class="table">
                ...
                ?>
                    <tr>
                        ...
                        <td><a class="btn btn-dark" href="hapus_pelanggan.php?id_pelanggan=<?php echo $data_pl['id_pelanggan']; ?>" role="button"  onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a></td>
                    </tr>
